...
You need a `SLACK_USER_TOKEN` in your HansCorp `.env` file. If you haven't set this up yet, follow these steps:

### Getting your Slack User OAuth Token

1. Go to [api.slack.com/apps](https://api.slack.com/apps) and click **Create New App**
2. Choose **From scratch** (not "From an app manifest")
3. Name it (e.g. `HansCorp`), select your workspace, click **Create App**
...
The CLI lives at the HansCorp project root. All commands must run from the project directory (the CLI reads `.env` from `cwd`):
