...
1. **The dashboard'\''s per-agent avatar uploader** (Agents tab → click your card → camera icon on the avatar). That sets the avatar shown inside Straxis — NOT the one on Telegram.
