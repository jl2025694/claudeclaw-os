...
const conversations: AgentConvo[] = [
  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    turns: [
      ...
      { user: 'I am building HansCorp as an open source project. The repo is at earlyaidopters/claudeclaw on GitHub. It is a Telegram bot powered by Claude Code that runs as a persistent service. I want it to become the reference implementation for personal AI assistants.', assistant: 'Noted. HansCorp is your open-source reference implementation for personal AI assistants, living at earlyaidopters/claudeclaw.', expectStore: true, label: 'project context' },
    ],
  },
