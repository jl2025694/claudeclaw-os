...
<title>Straxis Mission Control</title>
...
<div class="flex items-center justify-between mb-1">
  <div class="flex items-center gap-3">
    <h1 class="text-xl font-bold text-white">Straxis <span style="font-size:13px;font-weight:400;color:#6b7280">Mission Control</span></h1>
...
function cawGoStep2() {
  ...
  document.getElementById('caw-suggested-name').textContent = 'Straxis ' + label;
  document.getElementById('caw-suggested-username').textContent = 'straxis_' + id.replace(/-/g, '_') + '_bot';
