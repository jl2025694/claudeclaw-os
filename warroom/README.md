# War Room - HansCorp Voice Meeting Server

Real-time voice conversations with HansCorp's AI agents. Each agent has a distinct voice. You speak, the right agent responds.
...
- The HansCorp Node.js project built (`npm run build`)
