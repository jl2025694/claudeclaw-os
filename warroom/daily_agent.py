...
def main():
    parser = argparse.ArgumentParser(description="HansCorp Daily.co voice agent")
    parser.add_argument("--room-url", required=True, help="Full Daily room URL")
    parser.add_argument("--agent", default="main", help="Which HansCorp agent persona to use")
